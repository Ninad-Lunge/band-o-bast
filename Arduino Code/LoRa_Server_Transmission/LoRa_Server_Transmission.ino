...
const char *serverIP = "192.168.254.170"; // Replace with the IP address of your ESP8266 server
const int serverPort = 80; // Port of your server
const int loraFrequency = 433E6; // LoRa frequency, adjust based on your region

WiFiClient wifiClient; // Declare WiFiClient instance
